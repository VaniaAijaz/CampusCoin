...
const aiCategorize = async (req, res) => {
  try {
    ...
    const rules = [
      { keywords: ["cafe", "restaurant", "food", "eat", "lunch", "dinner", "breakfast", "pizza", "burger", "canteen", "biryani", "chai", "starbucks", "coffee", "grocery"], category: "Food" },
      { keywords: ["bus", "uber", "taxi", "ride", "train", "metro", "fuel", "petrol", "transport", "rickshaw", "fare", "gas"], category: "Transport" },
      { keywords: ["rent", "hostel", "room", "accommodation", "housing", "flat", "dorm"], category: "Hostel/Rent" },
      { keywords: ["book", "tuition", "stationery", "course", "exam", "fee", "library", "pen", "notebook", "academic", "class", "udemy"], category: "Academics" },
      { keywords: ["netflix", "spotify", "subscription", "youtube premium", "app", "streaming", "prime", "chatgpt"], category: "Subscriptions" },
      { keywords: ["movie", "cinema", "concert", "game", "party", "outing", "entertainment", "steam", "bowling"], category: "Entertainment" },
      { keywords: ["allowance", "pocket money", "family", "parents"], category: "Allowance" },
      { keywords: ["salary", "job", "work", "freelance", "part-time", "part time", "stipend"], category: "Part-time Job" },
      { keywords: ["scholarship", "grant", "bursary", "fellowship"], category: "Scholarship" },
...
// GET /api/tips/forecast — next-month forecast
