...
const setBudget = async (req, res) => {
  try {
    ...
    const result = await Transaction.aggregate([
      { $match: { userId: req.user._id, categoryId: new (require("mongoose").Types.ObjectId)(categoryId), type: "expense", date: { $gte: monthDate, $lte: endOfMonth }, isDeleted: false } },
    ...
    const budget = await Budget.findOneAndUpdate(
      ...
      { limitAmount, spentAmount, alertSent: false },
